program tan_test
  ...
  call y1%chain()
  call expect_float_eq(y1%val(), tan(1.4d0))
  call expect_float_eq(y1%adj(), 1.0d0)
  call expect_float_eq(x%adj(), 1.0d0/cos(1.4d0)/cos(1.4d0))
  ...
  call expect_float_eq(y2%val(), tan(tan(1.4d0)))
  ...
  call expect_float_eq(y1%adj(), 1.d0/cos(tan(1.4d0))/cos(tan(1.4d0)))
