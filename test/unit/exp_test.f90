program exp_test
  ...
  call y1%chain()
  call expect_float_eq(y1%val(), exp(1.5d0))
  call expect_float_eq(y1%adj(), 1.0d0)
  call expect_float_eq(x%adj(), exp(1.5d0))
  ...
  call expect_float_eq(y2%val(), exp(exp(1.5d0)))
  ...
  call expect_float_eq(y1%adj(), exp(exp(1.5d0)))
