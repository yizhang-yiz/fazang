program atan_test
  ...
  call y1%chain()
  call expect_float_eq(y1%val(), atan(1.5d0))
  call expect_float_eq(y1%adj(), 1.0d0)
  call expect_float_eq(x%adj(), 1.0d0 / (1.d0 + 1.5d0 * 1.5d0))
  ...
  call expect_float_eq(y2%val(), atan(atan(1.5d0)))
  ...
  call expect_float_eq(y1%adj(), 1.d0/(1.d0 + atan(1.5d0) * atan(1.5d0)))
