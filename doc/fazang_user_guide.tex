...
\large User's Guide \\  (Version pre-release)}
\hypersetup{
 pdfauthor={Yi Zhang},
...
\label{sec:orgdb94362}
\label{appendix:likelihood}  
\section{Normal distribution}
\label{sec:org5ddda6c}
\begin{equation}
